...
$$
\tilde{S} := \left\{ \sum_{i = 1}^n \alpha_i x_i : n \in \N, x_i \in S\ \text{for all}\ i, \alpha_i \geq 0\ \text{for all}\ i,\ \text{and}\ \sum_{i = 1}^n \alpha_i = 1 \right\};
$$
...
$$
\convex S := \bigcap \left\{ G \subseteq \R^m : S \subseteq G\ \text{and}\ G\ \text{is convex} \right\}.
$$
:::
