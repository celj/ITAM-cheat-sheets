...
1. Continuous in $\mathrm{p}$.
2. Zero degree homogeneity.
3. $\langle \mathrm{p}, Z(\mathrm{p}) \rangle = 0$.
...
$$
\pi^*_j \deq \max_{ \mathrm{z}_j }\ p_l f_{j,l} (\mathrm{z}_\ell) - \sum_{\ell \in \L} p_\ell \mathrm{z}_{j, \ell}.
$$
